...
public class ReviewLetter2 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.answer1:answer=button1.getText().toString();flush(QList.get(count));break;
            case R.id.answer2:answer=button2.getText().toString();flush(QList.get(count));break;
            case R.id.answer3:answer=button3.getText().toString();flush(QList.get(count));break;
            case R.id.answer4:answer=button4.getText().toString();flush(QList.get(count));break;
            default:break;
        }
        count++;

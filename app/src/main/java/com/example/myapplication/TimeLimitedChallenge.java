...
public class TimeLimitedChallenge extends AppCompatActivity implements View.OnClickListener {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    ...
                    if (score <= wordnum) {
                        ...
                        showDialog("挑战结束，得分" + wordnum + "   历史最高得分" + record);
                        return;
                    }
                }
            }
    ...
    public void btnchange(Button choice) {
        if (nowword.getChineses() == choice.getText().toString())
            choice.setBackground(tbtn.getConstantState().newDrawable());
        else choice.setBackground(fbtn.getConstantState().newDrawable());
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalnum = al.size();
        tbtn = getResources().getDrawable(R.drawable.truebtn);

        fbtn = getResources().getDrawable(R.drawable.falsebtn);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.answer1:
                if (answer == choice1.getText().toString()) {
                    score++;
                }
                ...
                break;
            case R.id.answer2:
                if (answer == choice2.getText().toString()) {
                    score++;
                ...
                break;
            case R.id.answer3:
                if (answer == choice3.getText().toString()) {
                    score++;
                ...
                break;
            case R.id.answer4:
                if (answer == choice4.getText().toString()) {
                    score++;
